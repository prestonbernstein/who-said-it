...
Class(function Text() {
    this.QUOTES = [{
        ...
        quote: "If you look back in history of the women who are most memorable and most stylish, they were never the followers of fashion. They were the ones who were unique in their style, breakers of the rules. They were authentic, genuine, original. They were not following the trends.",
        author: "Nina Garcia"
    }, {
        quote: "You may write me down in history with your bitter, twisted lines. You may trod me in the very dirt, but still, like dust, I'll rise.",
        author: "Maya Angelou"
    }, {
        quote: "Religion is part of the human make-up. It's also part of our cultural and intellectual history. Religion was our first attempt at literature, the texts, our first attempt at cosmology, making sense of where we are in the universe, our first attempt at health care, believing in faith healing, our first attempt at philosophy.",
        author: "Christopher Hitchens"
    }, {
        quote: "How arrogant - how very far from humility - would be the self-satisfied, smug assurance that God, a tidy-up-after-us God will come and clean up our mess? Hope for a nanny God, who will with a miracle grant us amnesty from our folly - that's not aligned with either history or the text of the Bible.",
...
Class(function Quotes() {
    ...
    function a() {
        d = e.initClass(QuotesView)
    }
});
Class(function QuotesQuote(b) {
    Inherit(this, View);
    var j = this;
    var m, c, e;
    ...
    var n = Math.round((50 - b.quote.length / 3) + a / 60);
    if (Mobile.phone) {
        n = 26
    }
...
Class(function QuotesView() {
    ...
    function m() {
        ...
        j.text("Who Said It?".toUpperCase());
        j.transform({
            y: 20
        }).tween({
            y: 0,
